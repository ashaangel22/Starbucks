...
(function ($) {
    ...
    $.fn.slabText = function (options) {
        ...
        return this.each(function () {
            ...
            var grabPixelFontSize = function grabPixelFontSize() {
            ...
            var resizeSlabs = function resizeSlabs() {
                ...
                if (settings.viewportBreakpoint && settings.viewportBreakpoint > viewportWidth || settings.headerBreakpoint && settings.headerBreakpoint > parentWidth) {
